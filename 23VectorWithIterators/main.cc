...
/****************************************************************
 * Main program for demonstrating iterating over a vector.
 *
...
int main(int argc, char *argv[]) {
  ...
  // create the vector from an input stream and then dump it
  the_vector.CreateVector(in_file);
  out_stream << kTag << "THE VECTOR\n" << the_vector.ToString() << endl;
  out_stream.flush();
