...
/****************************************************************
 * Function to read data from an opened 'Scanner'.
 *
 * Parameter:
 *   in_scanner -- the opened 'Scanner' from which to read
**/
void Record::ReadData(Scanner& in_scanner) {
  string inputline;
  ScanLine scanline;

//  Utils::log_stream << kTag << "enter ReadData" << endl;

  inputline = in_scanner.NextLine();
...
//  cout << kTag << this->ToString() << endl;
//  Utils::log_stream << kTag << "leave ReadData" << endl;
} // void Record::ReadData(Scanner& inScanner) const
