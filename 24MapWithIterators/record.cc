 ...
 * This compares based on the value of 'name' 
 *
 * Parameters:
...
/****************************************************************
 * Comparison function to compare one 'Record' against another.
 * This compares based on the value of 'office' 
 *
 * Parameters:
 *   a -- the first 'Record' instance
 *   b -- the second 'Record' instance
...
/****************************************************************
 * Comparison function to compare one 'Record' against another.
 * This compares based on the value of 'phone' 
 *
 * Parameters:
 *   a -- the first 'Record' instance
 *   b -- the second 'Record' instance
...
/****************************************************************
 * Comparison function to compare one 'Record' against another.
 * This compares based on the value of 'teaching' 
 *
 * Parameters:
 *   a -- the first 'Record' instance
 *   b -- the second 'Record' instance
